...
namespace Stock_Market_Dashboard.Data
{
    public class CompanyNewsArticle
    {
        ...
        public long datetime { get; set; }       // Published time in UNIX timestamp

        public string headline { get; set; }    // News headline

        public long id { get; set; }             // News ID.This value can be used for minId params to get the latest news only
